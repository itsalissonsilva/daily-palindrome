...
Four divisibility declarations passed Lean 4 verification after 1,108 empirical checks. Together they cover the two-, four-, and six-digit base-10 cases and the general two-digit base-$b$ identity.
...
* **Search Space**: 1 integer scanned in base 2.
* **Counterexamples Discovered**: 0
